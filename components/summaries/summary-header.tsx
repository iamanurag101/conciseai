            ...
            <div className="space-y-6">
                <div className="flex flex-wrap items-center gap-4">
                    <Badge
                        ...
                        backdrop-blur-xs rounded-full hover:bg-white/90 transition-all duration-200 
                        shadow-xs hover:shadow-md"
                    >
                        <Sparkles className="h-6 w-6 mr-1.5 text-orange-600" />
                        <p className="text-base text-orange-600 select-none">Powered by AI</p>
                    </Badge>
            ...
            <div className="self-start">
                <Link href="/dashboard">
                    <Button
                        ...
                        hover:shadow-md border border-orange-100/30 bg-orange-100 px-2 sm:px-3
                        no-underline hover:no-underline"
                    >
                        <ChevronLeft
                        className="h-3 w-3 sm:h-4 sm:w-4 text-orange-500 transition-transform 
